...
learnings, the Jarvis persona's route-don't-do discipline, and whether a worker handed
a knowledge *index* actually retrieves from it. They cost tokens and need a logged-in
Claude Code, so they are opt-in:
