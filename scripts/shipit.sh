...
#
#   OPERATION.md           no longer among them: bootstrap_project() refuses to write
#                          a TRACKED copy (issue 279), so this entry now only covers a
...
#
# This exemption was never the problem it looked like: the release it protects was
